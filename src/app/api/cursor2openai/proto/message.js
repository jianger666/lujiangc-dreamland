...
$root.AvailableModelsResponse = (function () {
  ...
  AvailableModelsResponse.decode = function decode(reader, length) {
    ...
    var end = length === undefined ? reader.len : reader.pos + length,
      message = new $root.AvailableModelsResponse();
    while (reader.pos < end) {
      var tag = reader.uint32();
      switch (tag >>> 3) {
        case 2: {
          if (!(message.models && message.models.length)) message.models = [];
          message.models.push(
  ...
  AvailableModelsResponse.fromObject = function fromObject(object) {
    if (object instanceof $root.AvailableModelsResponse) return object;
  ...
  AvailableModelsResponse.AvailableModel = (function () {
    ...
    AvailableModel.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      var end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.AvailableModelsResponse.AvailableModel();
      while (reader.pos < end) {
        var tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
...
$root.MessageSummary = (function () {
  ...
  MessageSummary.encode = function encode(message, writer) {
    ...
    if (
      ...
      writer
        ...
        .string(message.previousSummaryId);
    return writer;
  };
  ...
  MessageSummary.decode = function decode(reader, length) {
    if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
    var end = length === undefined ? reader.len : reader.pos + length,
      message = new $root.MessageSummary();
    while (reader.pos < end) {
      var tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  MessageSummary.fromObject = function fromObject(object) {
    if (object instanceof $root.MessageSummary) return object;
...
$root.MessageThinking = (function () {
  ...
  MessageThinking.decode = function decode(reader, length) {
    if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
    var end = length === undefined ? reader.len : reader.pos + length,
      message = new $root.MessageThinking();
    while (reader.pos < end) {
      var tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  MessageThinking.fromObject = function fromObject(object) {
    if (object instanceof $root.MessageThinking) return object;
...
$root.StreamUnifiedChatWithToolsRequest = (function () {
  ...
  StreamUnifiedChatWithToolsRequest.decode = function decode(reader, length) {
    if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
    var end = length === undefined ? reader.len : reader.pos + length,
      message = new $root.StreamUnifiedChatWithToolsRequest();
    while (reader.pos < end) {
      var tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  StreamUnifiedChatWithToolsRequest.Request = (function () {
    ...
    Request.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      var end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.StreamUnifiedChatWithToolsRequest.Request();
      while (reader.pos < end) {
        var tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
    ...
    Request.fromObject = function fromObject(object) {
      ...
      if (object.unknown22 != null) message.unknown22 = object.unknown22 | 0;
      ...
      if (object.unknown38 != null) message.unknown38 = object.unknown38 | 0;
      ...
      if (object.unknown48 != null) message.unknown48 = object.unknown48 | 0;
      if (object.unknown49 != null) message.unknown49 = object.unknown49 | 0;
      if (object.unknown51 != null) message.unknown51 = object.unknown51 | 0;
      if (object.unknown53 != null) message.unknown53 = object.unknown53 | 0;
      if (object.chatMode != null) message.chatMode = String(object.chatMode);
      return message;
    };
    ...
    Request.Message = (function () {
      ...
      Message.decode = function decode(reader, length) {
        ...
        var end = length === undefined ? reader.len : reader.pos + length,
          message =
            new $root.StreamUnifiedChatWithToolsRequest.Request.Message();
        while (reader.pos < end) {
          var tag = reader.uint32();
          switch (tag >>> 3) {
            case 1: {
      ...
      Message.fromObject = function fromObject(object) {
        if (
          object instanceof
          $root.StreamUnifiedChatWithToolsRequest.Request.Message
        )
          return object;
        var message =
          new $root.StreamUnifiedChatWithToolsRequest.Request.Message();
      ...
      Message.Image = (function () {
        ...
        Image.fromObject = function fromObject(object) {
          if (
            object instanceof
            $root.StreamUnifiedChatWithToolsRequest.Request.Message.Image
          )
            return object;
          var message =
            new $root.StreamUnifiedChatWithToolsRequest.Request.Message.Image();
        ...
        Image.Metadata = (function () {
          ...
          Metadata.decode = function decode(reader, length) {
            ...
            var end = length === undefined ? reader.len : reader.pos + length,
              message =
                new $root.StreamUnifiedChatWithToolsRequest.Request.Message.Image.Metadata();
            while (reader.pos < end) {
              var tag = reader.uint32();
              switch (tag >>> 3) {
                case 1: {
    ...
    Request.Instruction = (function () {
      ...
      Instruction.decode = function decode(reader, length) {
        ...
        var end = length === undefined ? reader.len : reader.pos + length,
          message =
            new $root.StreamUnifiedChatWithToolsRequest.Request.Instruction();
        while (reader.pos < end) {
          var tag = reader.uint32();
          switch (tag >>> 3) {
            case 1: {
      ...
      Instruction.fromObject = function fromObject(object) {
        if (
          object instanceof
          $root.StreamUnifiedChatWithToolsRequest.Request.Instruction
        )
          return object;
        var message =
          new $root.StreamUnifiedChatWithToolsRequest.Request.Instruction();
    ...
    Request.Model = (function () {
      ...
      Model.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
        var end = length === undefined ? reader.len : reader.pos + length,
          message = new $root.StreamUnifiedChatWithToolsRequest.Request.Model();
        while (reader.pos < end) {
          var tag = reader.uint32();
          switch (tag >>> 3) {
            case 1: {
      ...
      Model.fromObject = function fromObject(object) {
        if (
          object instanceof
          $root.StreamUnifiedChatWithToolsRequest.Request.Model
        )
          return object;
        var message =
        ...
        if (message.empty != null && message.hasOwnProperty("empty"))
          object.empty =
            options.bytes === String
              ...
              : options.bytes === Array
                ? Array.prototype.slice.call(message.empty)
                : message.empty;
        return object;
      };
    ...
    Request.CursorSetting = (function () {
      ...
      CursorSetting.fromObject = function fromObject(object) {
        if (
          object instanceof
          $root.StreamUnifiedChatWithToolsRequest.Request.CursorSetting
        )
          return object;
        var message =
          new $root.StreamUnifiedChatWithToolsRequest.Request.CursorSetting();
        ...
        if (object.unknown9 != null) message.unknown9 = object.unknown9 | 0;
        return message;
      };
    ...
    Request.Metadata = (function () {
      ...
      Metadata.decode = function decode(reader, length) {
        ...
        var end = length === undefined ? reader.len : reader.pos + length,
          message =
            new $root.StreamUnifiedChatWithToolsRequest.Request.Metadata();
        while (reader.pos < end) {
          var tag = reader.uint32();
          switch (tag >>> 3) {
            case 1: {
      ...
      Metadata.fromObject = function fromObject(object) {
        if (
          object instanceof
          $root.StreamUnifiedChatWithToolsRequest.Request.Metadata
        )
          return object;
        var message =
          new $root.StreamUnifiedChatWithToolsRequest.Request.Metadata();
        if (object.os != null) message.os = String(object.os);
        if (object.arch != null) message.arch = String(object.arch);
    ...
    Request.MessageId = (function () {
      ...
      MessageId.decode = function decode(reader, length) {
        ...
        var end = length === undefined ? reader.len : reader.pos + length,
          message =
            new $root.StreamUnifiedChatWithToolsRequest.Request.MessageId();
        while (reader.pos < end) {
          var tag = reader.uint32();
          switch (tag >>> 3) {
            case 1: {
      ...
      MessageId.fromObject = function fromObject(object) {
        if (
          object instanceof
          $root.StreamUnifiedChatWithToolsRequest.Request.MessageId
        )
          return object;
        var message =
          new $root.StreamUnifiedChatWithToolsRequest.Request.MessageId();
...
$root.StreamUnifiedChatWithToolsResponse = (function () {
  ...
  StreamUnifiedChatWithToolsResponse.decode = function decode(reader, length) {
    if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
    var end = length === undefined ? reader.len : reader.pos + length,
      message = new $root.StreamUnifiedChatWithToolsResponse();
    while (reader.pos < end) {
      var tag = reader.uint32();
      switch (tag >>> 3) {
        case 2: {
  ...
  StreamUnifiedChatWithToolsResponse.Message = (function () {
    ...
    Message.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      var end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.StreamUnifiedChatWithToolsResponse.Message();
      while (reader.pos < end) {
        var tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
    ...
    Message.WebTool = (function () {
      ...
      WebTool.decode = function decode(reader, length) {
        ...
        var end = length === undefined ? reader.len : reader.pos + length,
          message =
            new $root.StreamUnifiedChatWithToolsResponse.Message.WebTool();
        while (reader.pos < end) {
          var tag = reader.uint32();
          switch (tag >>> 3) {
            case 1: {
      ...
      WebTool.fromObject = function fromObject(object) {
        if (
          object instanceof
          $root.StreamUnifiedChatWithToolsResponse.Message.WebTool
        )
          return object;
        var message =
          new $root.StreamUnifiedChatWithToolsResponse.Message.WebTool();
      ...
      WebTool.toObject = function toObject(message, options) {
        if (!options) options = {};
        var object = {};
        if (options.arrays || options.defaults) object.webPage = [];
        if (message.webPage && message.webPage.length) {
          object.webPage = [];
      ...
      WebTool.WebPage = (function () {
        ...
        WebPage.decode = function decode(reader, length) {
          ...
          var end = length === undefined ? reader.len : reader.pos + length,
            message =
              new $root.StreamUnifiedChatWithToolsResponse.Message.WebTool.WebPage();
          while (reader.pos < end) {
            var tag = reader.uint32();
            switch (tag >>> 3) {
              case 1: {
        ...
        WebPage.fromObject = function fromObject(object) {
          if (
            object instanceof
            $root.StreamUnifiedChatWithToolsResponse.Message.WebTool.WebPage
          )
            return object;
          var message =
            new $root.StreamUnifiedChatWithToolsResponse.Message.WebTool.WebPage();
    ...
    Message.Unknown12 = (function () {
      ...
      Unknown12.fromObject = function fromObject(object) {
        if (
          object instanceof
          $root.StreamUnifiedChatWithToolsResponse.Message.Unknown12
        )
          return object;
        var message =
          new $root.StreamUnifiedChatWithToolsResponse.Message.Unknown12();
      ...
      Unknown12.Content = (function () {
        ...
        Content.decode = function decode(reader, length) {
          ...
          var end = length === undefined ? reader.len : reader.pos + length,
            message =
              new $root.StreamUnifiedChatWithToolsResponse.Message.Unknown12.Content();
          while (reader.pos < end) {
            var tag = reader.uint32();
            switch (tag >>> 3) {
              case 1: {
        ...
        Content.fromObject = function fromObject(object) {
          if (
            object instanceof
            $root.StreamUnifiedChatWithToolsResponse.Message.Unknown12.Content
          )
            return object;
          var message =
            new $root.StreamUnifiedChatWithToolsResponse.Message.Unknown12.Content();
